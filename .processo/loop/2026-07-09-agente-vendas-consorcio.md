...
| **SELO FINAL (pedido do Kairo)** | ⏳ revertido pro **claude** (modelo de prod; OpenAI era só validação) → test:unit → **Haiku coletor** monta dossiê dos 5 roteiros → **Fable** avalia → 10/10. Se selar: done-report + **develop→main** (deploy prod, develop 257 à frente). |
