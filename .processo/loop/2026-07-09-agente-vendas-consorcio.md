...
| onda 5 (cirúrgica G-R0) | ⏳ fix das 2 integração-vermelhas (TDD: testes já red) → suíte verde → re-Fable → done-report + `develop→main` (blast radius já verificado: só migration aditiva 0033, sem breaking) |
