...
| re-verificação (pós-onda-3, **OpenAI**) | ✅ test:unit **3321 verde**. 5 roteiros no OpenAI (`dossies-r9pos3/`, 4/5 sem erro; mario 1 erro a investigar). **Latência reveal DESPENCOU: ~33-35s** (era 62-64s) — FIX-289 dedupe + OpenAI mais rápido. ⏳ juiz Sonnet → `veredito-r9pos3-sonnet.md` |
