...
| execução onda 4 (raiz) | ⏳ 3 blocos disparados (sonnet): reveal-serverside `4bd9312d` (FIX-290 P0 — `comparison_table` fora do `emitServerCard`) · bevi-degradacao `fd9c28b6` (FIX-291 — retry ~480s pior caso sem cap+degradação) · valor-honestidade `6f88e2e9` (FIX-292/293). Base `integ/consorcio-r9-o4`. (1 workspace stale r9-3 subiu junto → deletado + pasta lingering arquivada.) |
