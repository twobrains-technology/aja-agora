...
abordagem: "(a) erro-estruturado-força-rebusca — defense-in-depth: fast-path de slug (marcador valor-em-k) + GroupNotInDiscoveryError pelo conjunto, capturado pela tool. ADR: docs/decisoes/blocos/2026-06-24-bloco-g-groupid-resolucao-robusta.md"
arquivos:
