...
1. Leia `docs/correcoes/README.md` (se existir), `docs/jornada/jornada-canonica.md` (a REGRA do fluxo), `docs/jornada/proposta-simulador.md` (conceito do Bernardo) e `docs/correcoes/todo/bloco-f-artifacts-produto/` — `_bloco.md` + os cards `fix-95`/`fix-96` (a decisão de UX já foi fechada com o Kairo e está detalhada lá).
