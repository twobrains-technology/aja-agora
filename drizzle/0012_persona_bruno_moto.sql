...
('moto', 'Bruno', 'specialist', 'moto',
  ...
  '[
    ...
    {"id":"moto-wa-narrativa","context":"Apos apresentar a primeira simulacao/recomendacao, oferece o WhatsApp com narrativa estrategica de continuidade ANTES de chamar present_whatsapp_optin","userMessage":"[sistema: usuario acabou de ver present_simulation_result pela primeira vez]","assistantResponse":"Suave, posso anotar seu WhatsApp? Assim se cair a internet ou voce sair daqui, a gente continua a conversa por la sem perder nada do atendimento.","whenCategory":["moto"],"whenIntent":["ready_to_proceed","providing_info"],"enabled":true,"origin":"manual"}
  ]'::jsonb,
  '[]'::jsonb,
  ...
  '["search_groups","simulate_quota","get_rates","get_group_details","recommend_groups","present_group_card","present_comparison_table","present_simulation_result","present_recommendation_card","compare_with_financing","present_financing_comparison","present_value_picker","present_topic_picker","save_contact_name","save_contact_whatsapp","present_whatsapp_optin"]'::jsonb,
  true, 1)
