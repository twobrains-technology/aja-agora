...
const testimonials = [
	{
		...
		content: "Achei meu consorcio em 5 minutos. Nunca foi tao facil!",
		rating: 5,
	},
	{
		name: "Carlos R.",
		...
		content: "A IA me mostrou opcoes que nenhum corretor apresentou.",
		rating: 5,
	},
	{
		name: "Ana L.",
		...
		content: "Simulei diferentes cenarios ate encontrar a parcela ideal.",
		rating: 5,
	},
];
	...
	return (
		<div className="flex gap-0.5">
			{Array.from({ length: rating }).map((_, i) => (
				<Star key={i} className="size-4 fill-foreground text-foreground" strokeWidth={1.5} />
			))}
		</div>
	);
}
				...
				<MotionPreset fade blur="4px" slide={{ direction: "up", offset: 16 }}>
					<div className="mb-12 space-y-4 text-center sm:mb-16">
						...
						<p className="text-muted-foreground mx-auto max-w-lg text-lg">
							Experiencias reais de quem ja usou o Aja Agora para encontrar o consorcio ideal.
						</p>
					</div>
				</MotionPreset>
