					...
					<CardContent className="flex flex-wrap items-center justify-between gap-8 px-8 sm:flex-nowrap sm:px-16 lg:px-24">
						<div className="max-w-xs lg:max-w-lg">
							...
							<p className="text-muted-foreground text-lg font-medium">
								With a variety of unique blocks, you can effortlessly create a page without any
								coding. Build your next landing page with ease.
							</p>
						</div>
						<div className="flex flex-wrap items-center gap-6 max-md:w-full max-md:flex-col md:justify-end">
							<a
								href="#"
								className="bg-card-foreground flex w-50 items-center gap-4 rounded-md px-6 py-3"
							>
								<img
