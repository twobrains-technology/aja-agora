...
import { ArrowRight, Bike, Bot, Car, Home, MessageCircle, Sparkles } from "lucide-react";
					...
					<div className="flex flex-col gap-6">
						...
						<MotionPreset fade blur="4px" slide={{ direction: "up", offset: 12 }} delay={0.3}>
							<p className="text-muted-foreground text-base sm:text-lg max-w-lg">
								Sem formulario, sem corretor. Converse com nosso consultor e encontre o consorcio
								sem juros, com a parcela que cabe no seu mes.
							</p>
						</MotionPreset>
													...
													return (
														...
														>
															...
															<motion.div
																...
																style={{
																	background:
																		"radial-gradient(circle at 50% 0%, var(--foreground) 0%, transparent 70%)",
																	opacity: 0.03,
																}}
															/>
