/**
 * Camila agent — especialista em consórcio de serviços (reforma, viagem,
 * formatura, cirurgia, estudo, etc).
 *
...
export function buildCamilaAgent(meta: ConversationMetadata) {
	const blocks = getSpecialistPrompt("servicos", meta.expertiseLevel ?? "neutro");
