...
/**
 * Uma cópia do que o cache tem agora.
 *
 * Existe para quem resolve em lote a partir do banco (`resolver-do-banco.ts`)
 * mesclar o que chegou com o que já estava — o cache é do processo e atende
 * páginas concorrentes, então trocar o conteúdo inteiro apagaria o que outra
 * requisição acabou de aprender.
 */
export function entradasDoCache(): Array<[string, CampanhaResolvida]> {
