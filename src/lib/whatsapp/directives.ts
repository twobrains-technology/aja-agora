...
1. Em 1-2 frases curtas NO SEU TOM, espelhe esse perfil de volta pro usuario E ja convide a olhar as opcoes que vao aparecer em seguida (ex: "Beleza, ${q.creditMax ?? 0} mil em [prazo], com lance — da uma olhada nas opcoes:"). NAO use bullets/checkboxes (✅), NAO use template, NAO descreva numeros especificos dos grupos.
...
O sistema entrega seu texto ANTES do card. Por isso seu texto deve introduzir o que vai aparecer, nao comentar atributos especificos. NAO chame recommend_groups.`;
}
