...
import { cleanupConversation, getLeadByConversationId, getConversation, getLeadEvents, closeDb } from "../../utils/db";
...
test.describe("P0-02 — Card WhatsApp opt-in", () => {
  ...
  test("CA-05 to CA-09: Card aparece pós-simulação e captura phone", async () => {
    ...
    const hasWhatsappOptinArtifact = afterSimText.includes('"type":"artifact","toolName":"present_whatsapp_optin"') || afterSimText.includes("whatsapp_optin");
